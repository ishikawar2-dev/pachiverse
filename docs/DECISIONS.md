...
- 価格は原価法の代表値の 5〜7 割に置く（高すぎる側の寄附金認定と、低すぎる側のみなし譲渡の両方を避ける）
- 月次売上の 3 点セットは作らない。会員数・保有者数を顧客基盤の資産として計上しない。利用規模 3 段は稼働の証拠としてのみ使う
- 評価書の依頼前に会計士・税理士へ 30 分の事前ヒアリングを行い、原価法＋陳腐化減価で書けることと費用感を確認する
...
### Consequences
- 評価額は収益系の手法より低め（減価後 4,000〜5,500 万円を想定）。手取りより否認耐性を優先する
